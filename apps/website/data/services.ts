...
export const services: Service[] = [
  {
    ...
    summary:
      "Bespoke platforms engineered for internal operations, enterprise workflow, and revenue-critical products.",
    ...
    method: [
      {
        title: "Diagnose",
        body: "Two weeks embedded with the team owning the workflow. We map the current state before writing a line of code.",
      },
      {
        title: "Architect",
        body: "System sketches, data model, integration surface. We choose boring, durable technology on purpose.",
      },
      {
        title: "Build",
        body: "Weekly demos, no surprises. Feature-flagged rollouts. Every release ships with dashboards.",
      },
      {
        title: "Steady state",
        body: "We hand the codebase back with a team ready to own it — or stay on retainer to keep steering.",
      },
    ],
    meta: {
      engagement: "Retainer / project",
      team: "3–7 engineers, 1 lead",
      timeline: "8–20 weeks",
    },
    faq: [
      {
        q: "How do you scope engagements?",
        a: "A one-week paid discovery ends in a fixed-fee proposal. Nothing binding until you see the shape of the work.",
      },
      {
        q: "Do you work with our existing engineering team?",
        a: "Frequently. We embed alongside your engineers, transfer patterns, and leave without leaving debt.",
      },
    ],
  },
  {
    ...
    category: "Engineering",
    summary:
      "Multi-tenant products engineered for the four-year horizon: onboarding, billing, retention, ops.",
    ...
    method: [
      {
        title: "Position",
        body: "Who converts, who stays, who pays. We build the product around the answer, not around a category.",
      },
      {
        title: "Scaffold",
        body: "Auth, tenancy, billing, roles — the seams that make or break the second year — set right the first time.",
      },
      {
        title: "Iterate",
        body: "Feature velocity paired with retention telemetry. We ship what compounds, not what demos.",
      },
      {
        title: "Compound",
        body: "As you sell up-market, we harden the platform for security review, SSO, audit logs, uptime SLAs.",
      },
    ],
    meta: {
      engagement: "Retainer + equity option",
      team: "4–8, cross-functional",
      timeline: "12–24 weeks to v1",
    },
    faq: [
      {
        q: "Do you build the initial version or take over an existing product?",
        a: "Both. Roughly a third of engagements are rescues — we inherit a codebase and refactor to a durable shape.",
      },
      {
        q: "How do you handle security and compliance?",
        a: "SOC 2 readiness, HIPAA, GDPR — patterns we've shipped multiple times. Compliance is a schedule item, not a scramble.",
      },
    ],
  },
  {
    ...
    category: "Engineering",
    summary:
      "Marketing surfaces built to load fast, rank well, and convert reliably — with editorial polish, not template polish.",
    ...
    method: [
      {
        title: "Position",
        body: "Message before pixels. A workshop distills what the site must say, to whom, in what order.",
      },
      {
        title: "Design",
        body: "Editorial layout systems, not landing-page templates. Typography-forward. Rhythm-driven.",
      },
      {
        title: "Build",
        body: "Static-first architecture. Next.js, Astro, or plain HTML when it earns its place.",
      },
      {
        title: "Grow",
        body: "SEO instrumentation, monthly performance reviews, iteration budget to keep the site improving.",
      },
    ],
    meta: {
      engagement: "Fixed-fee",
      team: "1 designer + 2 engineers + strategist",
      timeline: "6–12 weeks",
    },
    faq: [
      {
        q: "Do you write copy too?",
        a: "We collaborate closely with copywriters we trust, or with your team. We do not generate copy from templates.",
      },
      {
        q: "What CMS do you recommend?",
        a: "Sanity, Contentlayer, Payload, or a MDX-first setup depending on the editorial team.",
      },
    ],
  },
  {
    ...
    category: "Engineering",
    summary:
      "iOS + Android apps engineered for battery, network, and the App Store review process — not just the demo reel.",
    ...
    method: [
      {
        title: "Diagnose",
        body: "Which flows must be native? What can be shared? We start with the constraints.",
      },
      { title: "Prototype", body: "TestFlight-ready in six weeks. Real hands, real signal." },
      {
        title: "Scale",
        body: "State management, background sync, observability — the invisible reasons apps feel expensive.",
      },
      {
        title: "Ship",
        body: "We handle App Store review, phased rollout, and post-launch stability week-by-week.",
      },
    ],
    meta: {
      engagement: "Retainer / project",
      team: "2–4 mobile + backend",
      timeline: "10–20 weeks",
    },
    faq: [
      {
        q: "React Native or fully native?",
        a: "Depends on the surface. Video, camera, and heavy animation earn native. Most consumer flows do fine on React Native.",
      },
      {
        q: "Do you handle App Store submission?",
        a: "Yes. Rejection is expensive; we prepare submissions rigorously.",
      },
    ],
  },
  {
    ...
    category: "Engineering",
    summary:
      "Practical automation of the messy work: intake, routing, drafting, review. Measured on hours saved, not model choice.",
    ...
    method: [
      {
        title: "Watch",
        body: "We shadow the team doing the work. Automation candidates emerge from the calendar, not the pitch deck.",
      },
      {
        title: "Prototype",
        body: "Small, disposable, measurable. Two weeks per candidate. Winners graduate.",
      },
      {
        title: "Wire",
        body: "Production integration into the tools already in flight. No new dashboards to check.",
      },
      {
        title: "Govern",
        body: "Evals, monitoring, cost tracking, an off-switch. AI without governance is a liability.",
      },
    ],
    meta: {
      engagement: "Retainer",
      team: "1–3 engineers + 1 researcher",
      timeline: "4–12 weeks per workflow",
    },
    faq: [
      {
        q: "Which models do you use?",
        a: "We build model-agnostic pipelines. Right model, right task, swap when the price/quality curve moves.",
      },
      {
        q: "What about data privacy?",
        a: "Private cloud, on-prem, or self-hosted models — depending on your data classification.",
      },
    ],
  },
  {
    ...
    category: "Growth",
    summary:
      "SEO, content, and brand marketing built as a compounding asset — not a monthly report of vanity metrics.",
    ...
    method: [
      ...
      {
        title: "Distribute",
        body: "Owned channels first, borrowed second, paid last. Compound before you rent.",
      },
      {
        title: "Measure",
        body: "Attribution built to survive privacy shifts. Inbound demand as the north star.",
      },
    ],
    meta: {
      engagement: "Retainer",
      team: "1 strategist + 1 writer + 1 editor",
      timeline: "Ongoing",
    },
    faq: [
      {
        q: "Do you write the content or edit ours?",
        a: "Both — depends on your team's capacity. We ghostwrite for founders, edit for internal writers, or produce end-to-end.",
      },
      {
        q: "How long until we see results?",
        a: "Six months for measurable traffic, twelve for compounding. If someone promises faster, they're renting you traffic.",
      },
    ],
  },
  {
    ...
    category: "Growth",
    summary:
      "Paid acquisition run by operators who have carried a real P&L. LTV-aware, creative-first, measurement built to survive privacy shifts.",
    ...
    method: [
      {
        title: "Audit",
        body: "Where is money leaking? Attribution, creative fatigue, targeting, LP experience. Two-week diagnostic.",
      },
      {
        title: "Structure",
        body: "Account architecture rebuilt around your funnel, not the platform's default.",
      },
      {
        title: "Scale",
        body: "Creative velocity paired with disciplined testing. Winners scale, losers die on schedule.",
      },
      {
        title: "Diversify",
        body: "Reduce platform concentration. Own your data. Build measurement independent of the platforms.",
      },
    ],
    meta: {
      engagement: "Retainer + % of spend",
      team: "1 lead + 1 creative + 1 analyst",
      timeline: "Ongoing",
    },
    faq: [
      {
        q: "Minimum spend to work with you?",
        a: "$40k/mo media spend is the floor where our operating model earns its cost. Below that, we recommend other partners.",
      },
      {
        q: "Do you produce the creative?",
        a: "Yes. We think creative is where paid media is won.",
      },
    ],
  },
  {
    ...
    category: "Design",
    summary:
      "Editorial motion, brand films, and product videos — cut with the discipline of documentary and the precision of product marketing.",
    ...
    method: [
      {
        title: "Direct",
        body: "Story before shot list. What does this film need to make the viewer feel?",
      },
      {
        title: "Shoot",
        body: "Small crews, high control. We work with directors of photography we've collaborated with for years.",
      },
      { title: "Edit", body: "Rough cuts within a week. Sound design and grade last, not first." },
      {
        title: "Deliver",
        body: "Every aspect ratio, every subtitle language, master and mezzanine files — you own the assets.",
      },
    ],
    meta: {
      engagement: "Project",
      team: "Director + editor + colorist + sound",
      timeline: "4–8 weeks",
    },
    faq: [
      {
        q: "Do you also produce social-first vertical cuts?",
        a: "Yes. We deliver 9:16, 1:1, and 16:9 masters plus subtitle files by default.",
      },
      {
        q: "Do you shoot original footage?",
        a: "Yes — with a director of photography and small crew. We also work with stock and existing footage when it earns its place.",
      },
    ],
  },
  {
    ...
    category: "Design",
    summary:
      "Design engineered for how your product actually behaves — with the research, the writing, and the front-end all in one room.",
    ...
    method: [
      {
        title: "Study",
        body: "Talk to real users. Watch them work. Assumptions retire on Fridays.",
      },
      {
        title: "Frame",
        body: "Interaction models before pixels. What must the user do, feel, decide? In what order?",
      },
      {
        title: "Ship",
        body: "Designers embedded with engineers. Weekly critique. Motion, copy, and empty states shipped in the same PR.",
      },
      {
        title: "Refine",
        body: "Usability testing on the live product, not the prototype. Continuous iteration.",
      },
    ],
    meta: {
      engagement: "Retainer / project",
      team: "1 lead + 1 designer + 1 researcher",
      timeline: "8–16 weeks",
    },
    faq: [
      {
        q: "Do you use Figma?",
        a: "Yes, with a component-first system. Design tokens in code, mirrored in Figma via a token pipeline.",
      },
      {
        q: "Can you work with our existing design system?",
        a: "Yes — we extend, audit, or rebuild depending on its shape.",
      },
    ],
  },
  {
    ...
    method: [
      {
        title: "Position",
        body: "Who you serve, what you stand for, what you refuse. Positioning drives everything downstream.",
      },
      {
        title: "Explore",
        body: "Three distinct directions, not eight variations. Bold enough to argue about.",
      },
      { title: "Refine", body: "One direction chosen. Refined across a full application matrix." },
      {
        title: "Equip",
        body: "Guidelines + a live reference site. Templates for the surfaces your team touches weekly.",
      },
    ],
    meta: {
      engagement: "Fixed-fee",
      team: "Creative director + 2 designers + strategist",
      timeline: "10–16 weeks",
    },
    faq: [
      {
        q: "Do you handle naming?",
        a: "Yes, including legal + linguistic review with partners we trust.",
      },
      {
        q: "Do you refresh existing brands or start from zero?",
        a: "Both. Refresh work often has more constraints, and produces more interesting solutions.",
      },
    ],
  },
  {
    ...
    category: "Engineering",
    summary:
      "Long-tail support, upgrades, and reliability engineering for products already in production — yours or ours.",
    ...
    method: [
      {
        title: "Inherit",
        body: "Codebase audit. Runbook drafted. Observability wired. Two-week onboarding.",
      },
      {
        title: "Steady state",
        body: "Weekly cadence: security, dependencies, small improvements, monitoring.",
      },
      {
        title: "Respond",
        body: "On-call rotation with escalation. Incidents get post-mortems, not blame.",
      },
      {
        title: "Improve",
        body: "Quarterly reliability review with the roadmap for the next quarter's investment.",
      },
    ],
    meta: {
      engagement: "Monthly retainer",
      team: "2 engineers + 1 lead on rotation",
      timeline: "Ongoing",
    },
    faq: [
      {
        q: "Do you support products you didn't build?",
        a: "Yes, following a codebase audit. Some codebases need remediation before steady-state support is viable.",
      },
      {
        q: "What is your incident response like?",
        a: "24/7 for P0/P1 tiers. Response, mitigation, root-cause, post-mortem within one business week.",
      },
    ],
  },
];

export const servicesBySlug = Object.fromEntries(services.map((s) => [s.slug, s])) as Record<
  string,
  Service
>;
