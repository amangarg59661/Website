  ...
  if (status.kind === "ok") {
    return (
      ...
      >
        ...
        <p className="mt-6 max-w-[54ch] text-[var(--color-muted)]">
          A partner will read your note personally. If your inquiry is urgent, you can also message
          us on WhatsApp for a faster read.
        </p>
      </div>
    );
  }
