...
export function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="on-ink relative overflow-hidden isolate min-h-[92vh] flex items-center"
      style={{ cursor: "none" }}
      data-hero
    >
      ...
      <Container className="relative py-24 md:py-32 w-full">
        <PointerParallax containerRef={containerRef} strength={22}>
          {/* Meta ribbon */}
          <motion.div
            data-depth="0.15"
            className="flex flex-wrap items-center gap-3 kicker text-[color-mix(in_oklch,var(--color-paper)_74%,transparent)] will-change-transform"
          ...
          <h1
            data-depth="0.45"
            className="mt-14 md:mt-20 font-[family-name:var(--font-display)] text-[var(--text-display)] leading-[0.95] tracking-[-0.045em] text-[var(--color-paper)] will-change-transform"
          >
            <RevealLines
          ...
          <motion.p
            data-depth="0.3"
            className="mt-10 md:mt-14 max-w-[60ch] text-[var(--text-lede)] leading-[1.5] text-[color-mix(in_oklch,var(--color-paper)_84%,transparent)] will-change-transform"
          ...
          <motion.div
            data-depth="0.2"
            className="mt-12 md:mt-16 flex flex-wrap items-center gap-6 will-change-transform"
          ...
          >
            <MagneticCta href="/contact">
              <span
                className="inline-flex items-center gap-2 h-14 px-7 rounded-[var(--radius-sm)] bg-[var(--color-paper)] text-[var(--color-ink)] font-medium hover:bg-[color-mix(in_oklch,var(--color-paper)_92%,var(--color-ink))] transition-colors"
                style={{ cursor: "none" }}
              >
                Book a consultation
          ...
          <motion.dl
            data-depth="0.1"
            className="mt-16 md:mt-24 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl border-t border-[color-mix(in_oklch,var(--color-paper)_18%,transparent)] pt-8 will-change-transform"
        ...
        <a
          href="#next"
          className="hidden md:flex absolute right-8 bottom-8 items-center gap-3 kicker text-[color-mix(in_oklch,var(--color-paper)_74%,transparent)] hover:text-[var(--color-paper)] transition-colors"
          data-cursor="hover"
        >
