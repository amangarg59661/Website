 ...
 */
export function CursorLens({ containerRef }: { containerRef: React.RefObject<HTMLElement | null> }) {
  ...
  return (
    <>
      <div
        ref={ringRef}
        aria-hidden
        className="fixed left-0 top-0 pointer-events-none rounded-full z-[90]"
        style={{
          width: 36,
          height: 36,
