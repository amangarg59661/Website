...
export const cases: Case[] = [
  {
    ...
    narrative: [
      { heading: "The situation", body: "A twelve-year Rails monolith serving thirty-two internal teams. Deploys once every three weeks. New feature velocity in single digits per quarter." },
      { heading: "The wedge", body: "We refused the rewrite. Instead: a service topology that grew module by module, kept the monolith as the record system, and let the new architecture prove itself before earning trust." },
      { heading: "The compounding", body: "Deploy frequency crossed daily in month five. New features shipped in weeks, not quarters. The monolith remains — but it is now a shell around forty-one composable services." },
    ],
  ...
  },
  {
    ...
    narrative: [
      { heading: "The brief", body: "Build the clinical workflow layer for oncology practices — HIPAA-compliant, multi-tenant, and shipping paying customers before the founder's next board meeting." },
      { heading: "The shape", body: "We treated compliance as a schedule item, not a scramble. HIPAA-aware architecture from the schema up. Auth, audit logs, and BAAs on the critical path." },
      { heading: "The result", body: "First customer live at week eleven. SOC 2 Type I at week fourteen. Contracted ARR crossed seven figures inside seven months." },
    ],
  ...
  },
  {
    ...
    narrative: [
      { heading: "The shape", body: "Customs paperwork is repetitive, high-stakes, and adversarial with the rest of the day. We watched the intake desk for two weeks before writing anything." },
      { heading: "The wiring", body: "Ingest via email; extraction with an evaluator harness; draft in the operators' existing tool. Nothing new to check. Nothing new to learn." },
      { heading: "The compounding", body: "The team stopped staying late. Error rate — the metric they actually cared about — fell 64% because the AI never rushed." },
    ],
  ...
  },
  {
    ...
    narrative: [
      { heading: "The brief", body: "The bank was afraid of looking like the fintechs they compete with. And afraid of looking like they were pretending not to." },
      { heading: "The approach", body: "Restraint. A custom serif drawn by hand. A palette derived from the bank's original letterhead. A digital surface that would look at home in the vault." },
      { heading: "The reception", body: "94% client approval on the private survey. New relationships up 18% year-over-year. The refresh will outlive the next three CEOs." },
    ],
  ...
  },
  {
    ...
    narrative: [
      { heading: "The situation", body: "Growth had plateaued. Meta bore all the acquisition. Creative was produced monthly. Attribution was a Google Sheet." },
      { heading: "The rebuild", body: "Six-fold creative velocity. Channel diversification into TikTok and LinkedIn (yes, LinkedIn). Media mix modelling wired to a monthly board deck." },
      { heading: "The compounding", body: "Revenue crossed ten-fold in fourteen months on flat spend. MER climbed from 5.2 to 8.9. The founder took a real holiday." },
    ],
  ...
  },
  {
    ...
    narrative: [
      { heading: "The constraint", body: "The device fleet was eight years old. Half the network was 2G. A functioning cellular signal was not a design assumption." },
      { heading: "The build", body: "Offline-first architecture. Aggressive protobuf sync. UI drawn to survive at 240 nits in outdoor sun. Language support for four regional scripts." },
      { heading: "The impact", body: "47,000 daily users. Ledger disputes down 82%. The cooperative renewed the contract for four more years." },
    ],
...
export const casesBySlug = Object.fromEntries(cases.map((c) => [c.slug, c])) as Record<string, Case>;
