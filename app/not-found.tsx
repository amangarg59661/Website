    ...
    <>
      ...
      <main id="main">
        <section className="on-ink relative overflow-hidden">
          ...
          />
          <Container className="relative py-32 md:py-48 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-10">
            ...
            <aside className="md:col-span-4 md:pl-10 md:border-l border-[color-mix(in_oklch,var(--color-paper)_18%,transparent)]">
