          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="mt-3 space-y-2">
                ...
                <li>
                  <a href={`tel:${site.contact.phone}`} className="link-underline text-[var(--color-ink)]">
                    {site.contact.phone}
                  </a>
                </li>
                <li>
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-12">
            <Reveal as="div" className="md:col-span-4">
              ...
              <h2 className="mt-4 h2 max-w-[16ch]">Tell us what you&apos;re solving.</h2>
              <p className="lede mt-6 max-w-[42ch]">
                Every field below is used. A partner will read your note personally and reply
                with a proposal for a first call — usually within a business day.
              </p>
              <p className="mt-8 text-sm text-[var(--color-muted)] max-w-[42ch]">
