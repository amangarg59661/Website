        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-16">
            <Reveal as="div" className="md:col-span-5">
              ...
              <p className="mt-6 font-[family-name:var(--font-display)] text-[clamp(1.6rem,1.2rem+1.6vw,2.5rem)] leading-[1.15] tracking-[-0.02em] max-w-[24ch] text-[var(--color-ink)]">
                Every product a company ships is a promise it will keep for the next decade. We build the ones that keep.
              </p>
              <p className="lede mt-8 max-w-[54ch]">
                We are not the largest studio, nor the fastest. We are the studio you hire when the work is going to be used, seen, and re-read for years. Senior operators lead every engagement; the people who pitch are the people who ship.
              </p>
              <div className="mt-10 flex gap-6">
                <Link href="/about" className="link-underline kicker uppercase text-[var(--color-ink)]">
                  About the studio →
                </Link>
                <Link href="/portfolio" className="link-underline kicker uppercase text-[var(--color-ink)]">
                  Selected work →
                </Link>
              </div>
            </Reveal>
        ...
        <Container wide>
          <div className="flex items-baseline justify-between mb-10">
            <div>
              ...
              <h2 className="mt-4 h2 max-w-[22ch]">A shape you can trace across industries.</h2>
            </div>
        ...
        <Container>
          <div className="flex items-baseline justify-between mb-6">
            <div>
              ...
              <h2 className="mt-4 h2 max-w-[22ch]">Long-form writing from the studio.</h2>
            </div>
            <Link href="/blog" className="link-underline kicker uppercase hidden md:inline">
              All essays →
            </Link>
          </div>
