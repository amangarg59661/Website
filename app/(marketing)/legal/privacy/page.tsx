  ...
  return (
    <>
      <PageIntro
        ...
        lede={
          <>
            {legal.entity} (&quot;the studio&quot;, &quot;we&quot;) publishes this policy so anyone who visits or writes to us
            knows what data we collect, why, and how long we keep it.
          </>
        }
      />
        ...
        <Container reading>
          <article className="prose">
            ...
            <p>
              ...
              conversation moves to an engagement — draft a proposal. We do not share, sell, or
              rent inquiry data to any third party. Aggregate, anonymised traffic data is used to
            ...
            <h2>Cookies</h2>
            <p>
              We use one cookie category: strictly necessary. No advertising cookies. No
              cross-site tracking cookies. If we ever add a category, we will surface a banner
              with granular consent.
            </p>

            <h2>Retention</h2>
            <p>
              Inquiry emails are retained in the studio&apos;s CRM for the duration of the engagement
              plus twenty-four months. Server logs are retained for thirty days. On request, we
              will delete any personal data we hold about you within thirty days.
            </p>
