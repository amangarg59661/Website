  ...
  return (
    <>
      <PageIntro
        ...
        lede={
          <>
            These terms govern your use of {site.url}. By using the site, you agree to them. If
      ...
      <Section className="border-t border-[var(--color-line)]">
        <Container reading>
          <article className="prose">
            <h2>The site</h2>
            <p>
              This site is published by {legal.entity}, registered in {legal.jurisdiction}. It is
              a marketing surface — case studies, essays, and the studio&apos;s point of view. Nothing
            ...
            <p>
              The site is provided &quot;as is&quot;. To the extent permitted by law, we exclude all implied
              warranties, and our liability for anything arising from your use of the site is
              limited to the sum of INR one hundred (₹100).
            </p>

            <h2>Changes</h2>
            <p>
              We may revise these terms. The effective date at the top of the page reflects the
              last revision.
            </p>
