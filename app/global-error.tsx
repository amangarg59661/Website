    ...
    <html lang="en">
      ...
      >
        <main style={{ maxWidth: "44rem", margin: "0 auto" }}>
          <p style={{ letterSpacing: "0.14em", textTransform: "uppercase", fontSize: 12, opacity: 0.7 }}>
            Fatal error
          </p>
          <h1 style={{ marginTop: 24, fontSize: "clamp(2rem, 1.4rem + 3vw, 3.5rem)", lineHeight: 1.05, fontWeight: 500 }}>
          ...
          {error.digest && (
            <p style={{ marginTop: 24, opacity: 0.6, fontFamily: "ui-monospace, monospace", fontSize: 12 }}>
              Ref · {error.digest}
            </p>
          )}
        </main>
